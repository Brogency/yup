...
function SchemaType() {
  ...
  this._exclusive = (0, _create2.default)(null);
...
SchemaType.prototype = {
  ...
  _validate: function _validate(_value) {
    ...
    var reject = function reject() {
      return _promise2.default.reject(new ValidationError(errors, value));
    };
    ...
    result = endEarly ? _promise2.default.all(result) : _.collectErrors(result, value, path);
...
for (var method in aliases) {
  if (_.has(aliases, method)) aliases[method].forEach(function (alias) {
