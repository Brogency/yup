...
function createErrorFactory(orginalMessage, orginalPath, value, params, originalType) {
  return function createError() {
    ...
    return new ValidationError(formatError(message, babelHelpers.extends({ path: path, value: value }, params)), value, path, type);
  };
}
...
module.exports = function createValidation(_ref2) {
  ...
  function validate(_ref3) {
    ...
    var ctx = babelHelpers.extends({ path: path, parent: parent, createError: createError, type: name }, rest);
