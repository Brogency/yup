...
function createErrorFactory(orginalMessage, orginalPath, value, params, originalType) {
  return function createError() {
    ...
    return new ValidationError(formatError(message, (0, _extends3.default)({ path: path, value: value }, params)), value, path, type);
  };
}
...
module.exports = function createValidation(_ref2) {
  ...
  function validate(_ref3) {
    ...
    var rest = (0, _objectWithoutProperties3.default)(_ref3, ['value', 'path', 'state']);

    var createError = createErrorFactory(message, path, value, params, name);
    var ctx = (0, _extends3.default)({ path: path, parent: parent, createError: createError, type: name }, rest);
