...
inherits(StringSchema, MixedSchema, {
  _typeCheck: function _typeCheck(value) {
    return typeof value === 'string' || (typeof value === 'undefined' ? 'undefined' : babelHelpers.typeof(value)) === 'object' && value instanceof String;
  },
  ...
  max: function max(_max, msg) {
    return this.test({
      ...
      params: { max: _max },
      test: function test(value) {
        return value == null || value.length <= _max;
      }
    });
  },
